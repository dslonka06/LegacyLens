// Types from: @app/analysis/models/learning-path-analysis.model
...
// Types from: @app/analysis/models/system-understanding.model (inline)
...
export interface AnalysisSession {
  ...
  analysis: {
    ...
    modernizationSuggestions: { title?: string; description: string }[];
    dataFlow: string;
    summary: string;
    howItWorks: string;
    architecture: string;
...
export class LearningPathAnalysisEngine {
