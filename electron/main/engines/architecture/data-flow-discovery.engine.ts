// Types from: @app/knowledge/models/knowledge.model and @app/analysis/models/data-flow.model
...
export interface RepositoryStructure {
  root: { name: string; children: any[]; files: any[] };
  projects: any[];
  maxDepth: number;
...
export class DataFlowDiscoveryEngine {
