...
class DependencyMapperEngine {
  ...
  extractTypeScriptDeps(sf, allFiles) {
    const imports = [
  ...
  resolveAliasPath(importPath, allFiles) {
  ...
  resolveRelativePath(fromPath, importPath, allFiles) {
...
module.exports = { DependencyMapperEngine };
