...
function findByNames(files, names) {
...
function findByPathSegment(files, segment) {
...
function findByNameContaining(files, substring) {
...
class TechnologyDetectorEngine {
...
module.exports = { TechnologyDetectorEngine };
