class DependencyExplorerEngine {

  // ── Direct queries ──────────────────────────────────────────────────────

  incomingDependencies(nodeId, graph) {
  ...
  outgoingDependencies(nodeId, graph) {
  ...
  rankByConnectivity(graph, limit = 10) {
  ...
  dependencyHubs(graph, threshold = 2.0) {
...
module.exports = { DependencyExplorerEngine };
