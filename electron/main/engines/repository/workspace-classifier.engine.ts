...
import { TechnologyDetectorEngine, FileMetadata, TechnologyDetectionResult } from './technology-detector.engine';
import { RepositoryScannerEngine, RepositoryStructure } from './repository-scanner.engine';
import { ProjectDiscoveryEngine } from './project-discovery.engine';
...
export class WorkspaceClassifierEngine {

  constructor(
    private readonly technologyDetector: TechnologyDetectorEngine,
    private readonly repositoryScanner: RepositoryScannerEngine,
    private readonly projectDiscovery: ProjectDiscoveryEngine,
  ) {}
