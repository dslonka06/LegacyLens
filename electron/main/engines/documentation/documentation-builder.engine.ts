...
export interface RepositorySummary {
  ...
  modernizations?: Array<{ title: string; description: string }>;
  keyFiles?: Array<{ name: string; path: string; reason: string; connectionCount?: number }>;
  keyProjects?: Array<{ name: string; path: string; type: string; framework: string; language: string }>;
...
export class DocumentationBuilderEngine {
