import { DependencyExplorerEngine, FileRanking } from './dependency-explorer.engine';
import { RepositoryInsightsEngine } from './repository-insights.engine';
import { DataFlowDiscoveryEngine } from '../architecture/data-flow-discovery.engine';
import { WorkflowExplorerEngine } from '../architecture/workflow-explorer.engine';

// Types from: @app/analysis/models/repository-summary.model (inline)
...
// Types from: @app/knowledge/models/knowledge.model (inline)
...
export interface DependencyGraph {
  ...
  edges: { source: string; target: string; relationshipType: string }[];
}
...
// Types from: @app/knowledge/models/repository.model (inline)
...
// Types from: @app/workspace/models/workspace.model (inline)
...
// Types from: @app/workspace/models/workspace-context.model (inline)
...
export interface AnalysisSession {
  ...
  analysis: {
    ...
    modernizationSuggestions?: { description: string }[];
    patterns?: string[];
    [key: string]: any;
  };
  createdAt: string;
  aiAnalysis?: {
    ...
    modernizations?: { title: string; description: string }[];
...
export class RepositorySummaryEngine {
  ...
  constructor(
    private readonly explorer: DependencyExplorerEngine,
    private readonly insights: RepositoryInsightsEngine,
    private readonly dataFlowDiscovery: DataFlowDiscoveryEngine,
    private readonly workflowExplorer: WorkflowExplorerEngine,
  ) {}
