...
import { SearchResult, SearchResultType, SearchNavigationTarget } from '@app/features/search/models/search-result.model';
...
import { RepositoryInsight, RepositoryInsightsService } from '@app/analysis/services/repository-insights.service';
