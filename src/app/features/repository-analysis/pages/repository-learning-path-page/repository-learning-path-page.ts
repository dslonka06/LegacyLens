...
@Component({
  selector: 'app-repository-learning-path-page',
  standalone: true,
  imports: [CommonModule, RouterLink],
  templateUrl: './repository-learning-path-page.html',
  styleUrl: './repository-learning-path-page.scss',
})
export class RepositoryLearningPathPage implements OnInit, OnDestroy {
