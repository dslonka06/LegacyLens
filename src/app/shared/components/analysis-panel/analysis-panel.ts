...
import { AnalysisResult } from '@app/analysis/models/analysis-result.model';
import { AiAnalysisResult } from '@app/analysis/models/ai-analysis-result.model';
import { RiskItem } from '@app/analysis/models/risk-item.model';
import { ModernizationItem } from '@app/analysis/models/modernization-item.model';
