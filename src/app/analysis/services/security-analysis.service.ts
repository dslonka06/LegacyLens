...
import {
  ...
  SecurityHotspot,
  SecurityRelevantComponent,
  SecuritySeverity,
} from '../models/security-analysis.model';
import { AnalysisSession } from '../models/analysis-session.model';
import { RepositoryKnowledge, DependencyNode } from '@app/knowledge/models/knowledge.model';
...
export class SecurityAnalysisService {
  ...
  private extractSnippet(content: string, pattern: RegExp): string | null {
